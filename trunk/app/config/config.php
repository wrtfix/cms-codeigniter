...
if (defined('ENVIRONMENT')) {
    ...
    {
        case 'development':
            $config['base_url'] = "http://localhost/Codefight-CMS-2.6.1.0/trunk/";
            break;
...
|
*/
$config['encryption_key'] = 'as78d6f78sdsdfsdfsdf6f8sd7zx6fd8ds6f8s7d6fsd78';
...
$config['sess_cookie_name'] = 'cf_sessions';
$config['sess_expiration'] = 7200;
$config['sess_save_path'] = 'cf_sessions';
